...
class TestSlackClient(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.slack_client = SlackClient(config=self.config, slack_channel=self.slack_channel, init_block=False)
    ...
    def test_post_simple_message_success(self):
        ...
        self.mock_slack_client_instance.chat_postMessage.assert_called_once_with(channel=f"#{self.slack_channel}",
                                                                                 text=self.message)
    ...
    def test_send_secret_message_in_channel_success(self):
        ...
        self.mock_slack_client_instance.chat_postEphemeral.assert_called_once_with(channel=f"#{self.slack_channel}",
                                                                                   text=self.message, user=self.user)
    ...
    def test_update_block_message(self):
        ...
        self.mock_slack_client_instance.chat_postMessage.return_value = {"channel": self.slack_channel, "ts": "123.456"}
        self.slack_client.send_block_message()
    ...
    def test_add_success_block(self):
        ...
        self.mock_slack_client_instance.chat_postMessage.return_value = {"channel": "test_channel", "ts": "12345.678"}
        # Add success block
    ...
    def test_add_error_block(self):
        ...
        self.assertTrue(any("Error occurred" in block["elements"][0]["text"] for block in self.slack_client.blocks))
